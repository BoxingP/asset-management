...
def send_notification():
    ...
    grouped_df = df.groupby('Send Notification To').apply(lambda group: group.loc[:, [key_column, 'Model']])
    grouped_df.rename(columns={key_column: 'IT设备编号', 'Model': '型号'}, inplace=True)
